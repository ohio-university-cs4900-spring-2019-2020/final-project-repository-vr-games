...
uniform mat4 MVPMat;
uniform mat4 ProjectorMat; // Matrix for the Projective Texture Map (ie, the projector's VP matrix)
...
out vec4 ProjTexCoord; // Projection Texture Coordinate for this vertex
...
void main()
{
   ...
   ProjTexCoord = ( ProjectorMat * ModelMat * vec4( VertexPosition, 1 ) );

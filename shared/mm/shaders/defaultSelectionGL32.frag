#version 430
//Written by Scott Nykl. Default Shader for a Core 3.2+ WO Selection.
...
uniform vec4 SelectionColor; //woID stored in the R,G,B channels, Alpha is assumed to be 1.0
...
void main()
{
   FragColor = SelectionColor; //vec4(0,254.0/255.0,253.0/255.0,1);//
}